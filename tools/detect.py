...
import glob
import argparse
from flamnet.datasets.process import Process
from flamnet.models.registry import build_net
from flamnet.utils.config import Config
from flamnet.utils.visualization import imshow_lanes
from flamnet.utils.net_utils import load_network
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savedir', type=str, default="work_dirs/clr/FLAMNet_test/vision", help='The root of save directory')
